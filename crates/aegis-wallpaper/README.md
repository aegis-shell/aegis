...
`aegis-wallpaper` composes image, short-video, glTF, and multi-plane parallax
...
let layers = [
    aegis_wallpaper::ParallaxLayerSpec::new("far.png", 0.0),
    aegis_wallpaper::ParallaxLayerSpec::new("mid.png", 0.45),
    aegis_wallpaper::ParallaxLayerSpec::new("near.png", 1.0),
];
let mut wallpaper = aegis_wallpaper::Wallpaper::from_parallax_layers(
    &layers,
