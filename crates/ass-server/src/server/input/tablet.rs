...
impl Server {
    ...
    pub(crate) fn tablet_event(&mut self, event: ass_core::input::TabletEvent) {
    ...
    pub(crate) fn tablet_tip(&mut self, tool: u64, state: ass_core::input::ButtonState, time: u32) {
