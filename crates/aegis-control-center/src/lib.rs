...
use aegis_core::realm::RealmSnapshot;
                        ...
                        if bounds.w >= 640.0 {
                            frame.row_ex(
                                ...
                                |frame| {
                                    ...
                                    frame.flex(1.0);
                                    frame.scroll("aegis-ctl-center-page", |frame| {
                                        frame.column_ex(
                                            &LayoutOpts {
                                                gap: 12.0,
                                                cross: Align::Stretch,
                            ...
                            frame.flex(1.0);
                            frame.scroll("aegis-ctl-center-narrow-page", |frame| {
                                frame.column_ex(
                                    &LayoutOpts {
                                        gap: 12.0,
                                        cross: Align::Stretch,
