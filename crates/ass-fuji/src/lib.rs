//! fuji (宓姬, named after Lady Fu of the *Luoshen Fu*) — the ASS agent
//! product in one crate: [`bridge`] is the scoped MCP platform adapter
//! behind the `ass-fuji-mcp` binary; [`agent`] is fuji's self-contained
...
//! MCP client of the bridge, never through `ass_*` imports.
