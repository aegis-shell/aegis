...
use ass_fuji::agent::config::{ConfigError, FujiConfig};
use ass_fuji::agent::mcp_client::McpClient;
use ass_fuji::agent::provider::AnyProvider;
use ass_fuji::agent::session::{Session, SessionError};
use ass_fuji::agent::skills;
use ass_fuji::agent::{Agent, AgentError, AgentEvent};
...
# ASS desktop bridge — build with: cargo build --release -p ass-fuji
# [mcp.ass]
