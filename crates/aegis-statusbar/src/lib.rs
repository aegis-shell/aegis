//! Status bar chrome component for the aegis compositor.
//!
...
//! the status bar graduated out of `aegis-shell` into its own crate on top of
//! the same component seam (ADR-0021), following the ADR-0044 precedent;
//! ADR-0045 will cover this split. The composition root (the `aegis` binary)
