...
impl Localizer {
    ...
    pub fn text(self, message: Message) -> &'static str {
        ...
        match message {
            ...
            Message::SystemSettings => &catalog.system_settings,
            ...
            Message::InteractionManager => &catalog.interaction_manager,
            Message::InteractionManagerDescription => &catalog.interaction_manager_description,
            ...
            Message::PauseInteractionDomain => &catalog.pause_interaction_domain,
            Message::ResumeInteractionDomain => &catalog.resume_interaction_domain,
            Message::RevokeInteractionDomain => &catalog.revoke_interaction_domain,
            Message::ConfirmRevokeInteractionDomain => &catalog.confirm_revoke_interaction_domain,
...
struct Catalog {
    ...
    edge_scroll: String,
    interaction_manager: String,
    interaction_manager_description: String,
    ...
    pause_interaction_domain: String,
    resume_interaction_domain: String,
    revoke_interaction_domain: String,
    confirm_revoke_interaction_domain: String,
