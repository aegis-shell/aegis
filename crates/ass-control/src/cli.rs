...
/// Subcommands grouped under `ass-control realm`. They all share the
...
impl From<SwitchDir> for ass_core::workspace::Switch {
    fn from(value: SwitchDir) -> Self {
        match value {
            SwitchDir::Next => ass_core::workspace::Switch::Next,
            SwitchDir::Prev => ass_core::workspace::Switch::Prev,
        }
    }
}
