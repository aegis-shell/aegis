...
pub(crate) struct PendingLaunchPlacement {
    ...
    pub(crate) placement: aegis_model::workspace::LaunchPlacement,
...
) -> Option<aegis_model::workspace::LaunchPlacement> {
...
impl Server {
    ...
    pub fn register_launch_placement(
        ...
        app_ids: Vec<String>,
        pid: Option<u32>,
        placement: aegis_model::workspace::LaunchPlacement,
    ) {
...
mod tests {
    ...
    fn entry(
        ...
        PendingLaunchPlacement {
            ...
            pid,
            placement: aegis_model::workspace::LaunchPlacement::FreshWorkspace {
    ...
    fn label_of(placement: Option<aegis_model::workspace::LaunchPlacement>) -> Option<String> {
        match placement {
            Some(aegis_model::workspace::LaunchPlacement::FreshWorkspace { label }) => label,
