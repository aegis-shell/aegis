...
`aegis-model` is the backend-, protocol-, and renderer-agnostic state and
deterministic model contract shared by Aegis components.
...
`aegis-model` performs no Wayland, Vulkan, flux, lens, filesystem, socket, or
