...
//!
//! The crate consumes an explicit VRM model, optional legacy VRMA companion,
...
//! identity, still portraits, source precedence, XDG discovery, filesystem
//! observation, and surrounding chrome belong to the shared identity layer
...
pub use vrm::{AnimationSupport, CameraError, VrmCamera, VrmError as Error};
