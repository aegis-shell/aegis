...
`aegis-protocols` provides the canonical Wayland C ABI types and generated
...
The generated tables are immutable link-time data. They let `aegis-backend` and
`aegis-compositor` marshal core shell and extension messages without duplicating
