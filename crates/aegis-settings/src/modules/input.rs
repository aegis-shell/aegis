...
use aegis_model::input::{KeyboardConfig, MouseStatus, TouchpadScrollMethod, TouchpadStatus};
    ...
    fn render(
        ...
        frame.column_ex(&settings_card_layout(design), |frame| {
            ...
            changed |= frame.slider(
                ...
                &mut keyboard_rate,
                0.0,
                aegis_model::input::MAX_REPEAT_RATE as f32,
            );
            frame.row_ex(
                &LayoutOpts {
                    height: 18.0,
            ...
            changed |= frame.slider(
                ...
                &mut keyboard_delay,
                50.0,
                aegis_model::input::MAX_REPEAT_DELAY_MS as f32,
            );
            frame.row_ex(
                &LayoutOpts {
                    height: 18.0,
        ...
        if changed {
            ...
            keyboard.repeat_rate = keyboard_rate
                .round()
                .clamp(0.0, aegis_model::input::MAX_REPEAT_RATE as f32)
                as u32;
            keyboard.repeat_delay_ms = keyboard_delay
                .round()
                .clamp(1.0, aegis_model::input::MAX_REPEAT_DELAY_MS as f32)
                as u32;
