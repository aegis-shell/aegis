        ...
        let response = match method {
            "initialize" => rpc_result(
                ...
                json!({
                    ...
                    "instructions": "Use desktop_snapshot before desktop ids. The Agent Realm id is bridge-managed: never ask for or invent one. Capture before Realm input and verify queued effects with a fresh capture or journal."
                }),
            ),
