...
Realm tools over stateless stdio MCP `2026-07-28` for aegis-agent and any
other current MCP client, owns one subject-bound Agent Realm per connector
...
operations on first use. See the
