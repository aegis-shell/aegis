...
pub(super) enum CapabilityPickControl {
    ...
    Start {
        ...
        reply: std::sync::mpsc::Sender<Result<aegis_shell::CapabilityPickResult, String>>,
    },
...
pub(super) struct PendingCapabilityPick {
    pub(super) conn_id: u64,
    pub(super) reply: std::sync::mpsc::Sender<Result<aegis_shell::CapabilityPickResult, String>>,
}
