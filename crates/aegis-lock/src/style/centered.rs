...
use aegis_config::LockScreenStyle;
use aegis_design::AvatarRole;
use aegis_design::materials::chrome_place;
use aegis_lock::lock_layout_for;
...
impl StylePainter for CenteredPainter {
    ...
    fn paint_materials(&self, canvas: &Canvas, frame: &FramePresentation<'_>) {
        ...
        if frame.state.presentation() == aegis_lock::PresentationMode::Ambient && progress <= 0.02 {
            return;
        }
        ...
        ui.place(
            ...
            &chrome_place(
                ...
                LayoutOpts {
                    pad: 0.0,
                    cross: Align::Stretch,
                    ..aegis_design::materials::surface_layout()
                },
            ),
            |ui| {
                ui.row_ex(
