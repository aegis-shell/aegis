...
| [`aegis-hud`](../../crates/aegis-hud/README.md) | Display-only HUD status chips with the StatusNotifierItem tray row | [ADR-0081](../adr/0081-hud-and-command-panel-naming.md), [ADR-0083](../adr/0083-frameless-transient-toasts-and-hud-consolidation.md) |
| [`aegis-command-panel`](../../crates/aegis-command-panel/README.md) | Full-screen modal command panel: quick settings, hosted settings modules, tray activation, and notifications | [ADR-0081](../adr/0081-hud-and-command-panel-naming.md), [ADR-0114](../adr/0114-panel-hosted-settings-and-hud-command-panel.md) |
